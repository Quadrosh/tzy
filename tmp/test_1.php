...
<a href="#" id="target1" class="btn btn-primary">отправить заявку</a>

<?php
//Yii::$app->clientScript->registerScript('logo_as_image_script', '$(document).ready(function() {
//        $("#target1").click(function() {
//            $.post("'.Yii::$app->createAbsoluteUrl('site/test').'",
//                    {
//                        clicked: "1",
//                        tid:"2"
//                    },
...
<?=  \yii\helpers\Html::a('клик', ['/ts/target', 'tid' => '2'], [
...
<?=  \yii\helpers\Html::a('клик', ['/ts/target', 'tid' => '2'], ['class' => 'btn btn-danger', 'data' => ['tid' => '2', 'method' => 'post',]]) ?>

<a href="/ts/target/2" class="btn btn-primary" >клик</a>