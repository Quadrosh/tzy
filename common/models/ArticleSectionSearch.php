...
class ArticleSectionSearch extends ArticleSection
{
    ...
    public function rules()
    {
        return [
            ...
            [['header', 'header_class', 'description', 'raw_text', 'section_image', 'section_image_alt', 'background_image', 'thumbnail_image', 'call2action_description', 'call2action_name', 'call2action_link', 'call2action_class', 'call2action_comment', 'view', 'color_key', 'structure', 'custom_class'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'header', $this->header])
            ...
            ->andFilterWhere(['like', 'section_image', $this->section_image])
            ->andFilterWhere(['like', 'section_image_alt', $this->section_image_alt])
