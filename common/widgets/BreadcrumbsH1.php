 ...
 *
 */
class BreadcrumbsH1 extends Widget
{
    /**
...
//        echo '<pre>'.print_r($this->links,true).'</pre>';die;
        ...
        echo '<h1 class="breadcrumb_H1">'.$h1.'</h1>';
    ...
    protected function renderItem($link, $template)
    {
        ...
        if (array_key_exists('label', $link)) {
            ...
            throw new InvalidConfigException('The "label" element is required for each link in breadcrumbs.');
        }
