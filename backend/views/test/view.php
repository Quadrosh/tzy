...
<h2>Варианты</h2>
    <table class="table  table-bordered">
        ...
        <tr data-key="1">
            ...
            <td>
                <a href="/testpage/view?id=<?= $testPage['id'] ?>">
                    <span class="glyphicon glyphicon-eye-open"></span>
                </a>
                <a href="/testpage/update?id=<?= $testPage['id'] ?>">
                    <span class="glyphicon glyphicon-pencil"></span>
                </a>
                <a href="/testpage/delete?id=<?= $testPage['id'] ?>" data-confirm="Уверен, что хочешь удалить?" data-method="post">
                    <span class="glyphicon glyphicon-remove"></span>
                </a>


                <a href="/testpage/copy?id=<?= $testPage['id'] ?>">
                    <span class="glyphicon glyphicon-duplicate"></span>
                </a>
                <a href="/testtarget/create?testpage_id=<?= $testPage['id'] ?>">
    ...
    <?= Html::a('Create Test Page', ['/testpage/create', 'test_id'=>$model->id], ['class' => 'btn btn-success']) ?>

<h2>Цели</h2>
    <table class="table table-striped table-bordered">
        <thead>
        <tr>
            <th><a href="/testtarget/index?sort=id" data-sort="id">ID</a></th>
            <th><a href="/testtarget/index?sort=testpage_id" data-sort="testpage_id">Testpage</a></th>
            <th><a href="/testtarget/index?sort=testpage_id" data-sort="testpage_id">Testpage Name</a></th>
            <th><a href="/testtarget/index?sort=name" data-sort="name">Name</a></th>
            <th><a href="/testtarget/index?sort=achieve" data-sort="achieve">Achieve</a></th>
            <th>Конверсия</th>
            <th class="action-column">&nbsp;</th>
        </tr>
        </thead>
        ...
        <tr data-key="1">
            ...
            <td>
                <a href="/testtarget/view?id=<?= $testTarget['id'] ?>" title="View" aria-label="View" data-pjax="0">
                    <span class="glyphicon glyphicon-eye-open"></span>
                </a>
