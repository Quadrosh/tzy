...
use perevertish\models\Pereorder;
use Yii;
...
//            $this->layout = 'error';
    ...
    public function actionFeedback()
    {
        ...
        if ($feedback->load(Yii::$app->request->post())) {
            ...
            Yii::$app->session->setFlash('error', 'Во время отправки произошла ошибка, попробуйте еще раз. Или отправьте заявку в свободной форме на perevertish.ru@gmail.com или оформите заявку по телефону');
            return $this->redirect(Url::previous());
        }
